...
![Title screen of Combo Spells. Listing instructions on how to play.](./combo-spells/00.png)
...
![Gameplay of Combo Spells. Player is attacking dummy.](./combo-spells/02.png)
...
![Original sketch of the school project](./combo-spells/ske-01.jpg)
...
![Player control scheme](./combo-spells/cs-control-scheme.png)
...
![Working in progress version of Combo Spells. It's at the earliest version with no minimal graphics.](./combo-spells/01.png)

To this...

![2nd version of Combo Spells. The graphics are flat with strong colors. The player is attacking the dummy.](./combo-spells/02.png)

And after months of working on it, it became something like this.

![Final version of Combo Spells. There's a tree and areas have some shadows in them. The player going back to the right-side of the stage after casting.](./combo-spells/05.png)
...
![Debug menu that can be found on the right-side of the screen](./combo-spells/06.png)
...
Here are some additional sketches that I've made back then, when making the game. I even sketched original characters for it back then. Those were fun memories.

![Sketch of the game's interface, and character concepts.](./combo-spells/ske-02.jpg)

![Sketch that explores of another character named Merilyn. She has very round that's braided at the end like a pony-tail, and wears a patterned skirt that hints of her water abilities.](./combo-spells/ske-03.jpg)
